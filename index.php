      ...
      <div class="caption">
        <div class="holder"> <strong class="title">R. T. F.</strong>
          ...
          <div class="banner-btn-box">
            <a href="media-upload.php" class="btn-uploading"><span class="icon-icons-08"></span>Start Uploading</a>
            <a href="signup.php" class="btn-discover"><span class="fa fa-users"></span>Join the Family</a> </div>
        </div>
      </div>
    </div>
