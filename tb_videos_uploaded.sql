...
--
-- Table structure for table `tb_videos_uploaded`
--

CREATE TABLE `tb_videos_uploaded` (
...
--
-- Indexes for table `tb_videos_uploaded`
--
ALTER TABLE `tb_videos_uploaded`
...
--
-- AUTO_INCREMENT for table `tb_videos_uploaded`
--
ALTER TABLE `tb_videos_uploaded`
